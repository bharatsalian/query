view: billing_entity {
  sql_table_name: mem_persona.billing_entity ;;
  ...
  dimension: edit_plans_dur_amend_flag {
    type: string
    sql: ${TABLE}.edit_plans_dur_amend_flag ;;
  }
  ...
  dimension: single_prod_group_policy_flag {
    type: string
    sql: ${TABLE}.single_prod_group_policy_flag ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [disb_payee_name, payor_name, sort_name, dba_name, billing_entity_name]
  }
}
